...
class Spoopy:
	...
	async def on_server_join(self, server):
		...
		donate = "https://www.patreon.com/OKEPlazmA"
		sinv = "https://discord.gg/NG3PWaX"
		inv ="https://discordapp.com/oauth2/authorize?client_id=339220258026160131&scope=bot&permissions=2146958591"
		...
		if self.bot.user.avatar_url:
			...
			em.add_field(name="Owner", value="<@241723504620339201>")
